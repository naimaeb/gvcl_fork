...
# CUDA_VISIBLE_DEVICES=3 python ./src/run.py --nepochs 10 --experiment smnist --train_samples 4 --approach fsvi --seed 14 --reg_type kl_g  --lr 0.1 --sbatch 64 --optimizer sgd --beta 0.0 