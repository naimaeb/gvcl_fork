...
# example command: CUDA_VISIBLE_DEVICES=5 python ./src/sweep.py --sweep_name 'kl_g_gvcl-nofilm-max-mnist' --nepochs 10 --experiment smnist --train_samples 4 --approach gvcl --seed 14 --regularizer re_g
